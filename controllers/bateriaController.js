...
async function listarBaterias(req, res) {
    try {
...
//atualizar bateria
async function atualizarBateria(req, res) {
    try {
...
//deletar bateria
async function deletarBateria(req, res) {
    try {
...
module.exports = { criarBateria, listarBaterias, atualizarBateria, deletarBateria };